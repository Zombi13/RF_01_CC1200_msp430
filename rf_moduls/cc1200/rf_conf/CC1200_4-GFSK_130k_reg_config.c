...
static const registerSetting_t preferredSettings[]= 
{
  ...
  {CC120X_SYNC3,             0x00},   //4  Sync Word Configuration [31:24]
  {CC120X_SYNC2,             0x00},   //5  Sync Word Configuration [23:16]
  {CC120X_SYNC1,             0xD9},   //6  Sync Word Configuration [15:8]
  {CC120X_SYNC0,             0xCC},   //7  Sync Word Configuration [7:0]
  {CC120X_SYNC_CFG1,         0x47},   //8  Sync Word Detection Configuration Reg. 1
  {CC120X_SYNC_CFG0,         0x00},   //9  Sync Word Detection Configuration Reg. 0
  {CC120X_DEVIATION_M,       0x68},   //10  Frequency Deviation Configuration
  {CC120X_MODCFG_DEV_E,      0x2C},   //11  Modulation Format and Frequency Deviation Configur..
  ...
  {CC120X_IQIC,              0xEC},   //15  Digital Image Channel Compensation Configuration
  {CC120X_CHAN_BW,           0x09},   //16  Channel Filter Configuration
  ...
  {CC120X_SYMBOL_RATE2,      0x9A},   //19  Symbol Rate Configuration Exponent and Mantissa [1..
  {CC120X_SYMBOL_RATE1,      0x9F},   //20  Symbol Rate Configuration Mantissa [15:8]
  {CC120X_SYMBOL_RATE0,      0xBE},   //21  Symbol Rate Configuration Mantissa [7:0]
