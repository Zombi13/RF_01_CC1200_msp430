...
static const registerSetting_t preferredSettings[]= 
{
  ...
  {CC120X_SYNC_CFG1,         0xAC},    //8    //Sync Word Detection Configuration Reg. 1
  {CC120X_DEVIATION_M,       0xD7},    //10    //Frequency Deviation Configuration
  {CC120X_MODCFG_DEV_E,      0x1A},    //11    //Modulation Format and Frequency Deviation Configur..
  {CC120X_DCFILT_CFG,        0x13},    //12    //Digital DC Removal Configuration
  {CC120X_PREAMBLE_CFG0,     0xE3},    //14    //Preamble Detection Configuration Reg. 0
  {CC120X_IQIC,              0x00},    //15    //Digital Image Channel Compensation Configuration
  {CC120X_CHAN_BW,           0x0D},    //16    //Channel Filter Configuration
  {CC120X_MDMCFG0,           0x02},    //18    //General Modem Parameter Configuration Reg. 0
  {CC120X_SYMBOL_RATE2,      0x5F},    //19    //Symbol Rate Configuration Exponent and Mantissa [1..
  {CC120X_SYMBOL_RATE1,      0x75},    //20    //Symbol Rate Configuration Mantissa [15:8]
  {CC120X_SYMBOL_RATE0,      0x10},    //21    //Symbol Rate Configuration Mantissa [7:0]
  {CC120X_AGC_REF,           0x35},    //22    //AGC Reference Level Configuration
  {CC120X_AGC_CS_THR,        0xEC},    //23    //Carrier Sense Threshold Configuration
  {CC120X_AGC_CFG3,          0x31},    //25    //Automatic Gain Control Configuration Reg. 3
  {CC120X_AGC_CFG1,          0x24},    //27    //Automatic Gain Control Configuration Reg. 1
  {CC120X_AGC_CFG0,          0x9F},    //28    //Automatic Gain Control Configuration Reg. 0
  ...
  {CC120X_ASK_CFG,           0xB7},    //45    //ASK Configuration
  {CC120X_PKT_LEN,           0xFF},    //46    //Packet Length Configuration
  {CC120X_IF_MIX_CFG,        0x1C},    //12032    //IF Mix Configuration
  {CC120X_FREQOFF_CFG,       0x00},    //12033    //Frequency Offset Correction Configuration
  {CC120X_MDMCFG2,           0xFC},    //12037    //General Modem Parameter Configuration Reg. 2
  ...
  {CC120X_FS_DIG1,           0x07},    //12050    //Frequency Synthesizer Digital Reg. 1
  {CC120X_FS_DIG0,           0xA0},    //12051    //Frequency Synthesizer Digital Reg. 0
  ...
  {CC120X_FS_DVC0,           0x17},    //12061    //Frequency Synthesizer Divider Chain Configuration ..
