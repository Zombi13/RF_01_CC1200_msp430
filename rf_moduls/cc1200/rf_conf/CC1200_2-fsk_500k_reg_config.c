...
static const registerSetting_t preferredSettings[]= 
{
  ...
  {CC120X_SYNC_CFG0,         0x13},  //9  //Sync Word Detection Configuration Reg. 0
  {CC120X_DEVIATION_M,       0x99},  //10  //Frequency Deviation Configuration
  {CC120X_MODCFG_DEV_E,      0x05},  //11  //Modulation Format and Frequency Deviation Configur..
  {CC120X_DCFILT_CFG,        0x26},  //12  //Digital DC Removal Configuration
  ...
  {CC120X_CHAN_BW,           0x02},  //16  //Channel Filter Configuration
  ...
  {CC120X_AGC_CFG1,          0x16},  //27  //Automatic Gain Control Configuration Reg. 1
