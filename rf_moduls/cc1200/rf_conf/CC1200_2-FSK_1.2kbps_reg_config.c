...
static const registerSetting_t preferredSettings[]= 
{
  ...
  {CC120X_SYNC_CFG1,         0x4A},      //8  //Sync Word Detection Configuration Reg. 1
  {CC120X_DEVIATION_M,       0xD1},      //10  //Frequency Deviation Configuration
  {CC120X_MODCFG_DEV_E,      0x00},      //11  //Modulation Format and Frequency Deviation Configur..
  {CC120X_DCFILT_CFG,        0x5D},      //12  //Digital DC Removal Configuration
  {CC120X_PREAMBLE_CFG1,     0x10},      //13  //Preamble Length Configuration Reg. 1
  {CC120X_PREAMBLE_CFG0,     0x8A},      //14  //Preamble Detection Configuration Reg. 0
  {CC120X_IQIC,              0xCB},      //15  //Digital Image Channel Compensation Configuration
  {CC120X_CHAN_BW,           0xA6},      //16  //Channel Filter Configuration
  {CC120X_MDMCFG1,           0x40},      //17  //General Modem Parameter Configuration Reg. 1
  {CC120X_MDMCFG0,           0x05},      //18  //General Modem Parameter Configuration Reg. 0
  {CC120X_SYMBOL_RATE2,      0x3F},      //19  //Symbol Rate Configuration Exponent and Mantissa [1..
  ...
  {CC120X_AGC_REF,           0x20},      //22  //AGC Reference Level Configuration
  {CC120X_AGC_CS_THR,        0xEC},      //23  //Carrier Sense Threshold Configuration
  {CC120X_AGC_CFG1,          0x51},      //27  //Automatic Gain Control Configuration Reg. 1
  {CC120X_AGC_CFG0,          0x87},      //28  //Automatic Gain Control Configuration Reg. 0
  ...
  {CC120X_FREQOFF_CFG,       0x22},      //12033  //Frequency Offset Correction Configuration
  {CC120X_MDMCFG2,           0x0C},      //12037  //General Modem Parameter Configuration Reg. 2
  ...
  {CC120X_FS_DIG0,           0xAF},      //12051  //Frequency Synthesizer Digital Reg. 0
