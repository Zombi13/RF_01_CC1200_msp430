...
static const registerSetting_t preferredSettings[]= 
{
  ...
  {CC120X_SYNC3,             0x6F},   //4  Sync Word Configuration [31:24]
  {CC120X_SYNC2,             0x4E},   //5  Sync Word Configuration [23:16]
  {CC120X_SYNC1,             0x90},   //6  Sync Word Configuration [15:8]
  {CC120X_SYNC0,             0x4E},   //7  Sync Word Configuration [7:0]
  {CC120X_SYNC_CFG1,         0xE5},   //8  Sync Word Detection Configuration Reg. 1
  ...
  {CC120X_MODCFG_DEV_E,      0x0B},   //11  Modulation Format and Frequency Deviation Configur..
  {CC120X_DCFILT_CFG,        0x56},   //12  Digital DC Removal Configuration
  {CC120X_PREAMBLE_CFG0,     0xBA},   //14  Preamble Detection Configuration Reg. 0
  {CC120X_IQIC,              0xC8},   //15  Digital Image Channel Compensation Configuration
  {CC120X_CHAN_BW,           0x84},   //16  Channel Filter Configuration
  ...
  {CC120X_SYMBOL_RATE2,      0x94},   //19  Symbol Rate Configuration Exponent and Mantissa [1..
  ...
  {CC120X_AGC_REF,           0x27},   //22  AGC Reference Level Configuration
  {CC120X_AGC_CS_THR,        0xF1},   //23  Carrier Sense Threshold Configuration
  {CC120X_AGC_CFG1,          0x11},   //27  Automatic Gain Control Configuration Reg. 1
  {CC120X_AGC_CFG0,          0x90},   //28  Automatic Gain Control Configuration Reg. 0
  {CC120X_FIFO_CFG,          0x00},   //29  FIFO Configuration
  {CC120X_FS_CFG,            0x12},   //32  Frequency Synthesizer Configuration
  {CC120X_PKT_CFG2,          0x24},   //38  Packet Configuration Reg. 2
  ...
  {CC120X_IF_MIX_CFG,        0x18},   //12032  IF Mix Configuration
  ...
  {CC120X_IFAMP,             0x05},   //12079  Intermediate Frequency Amplifier Configuration
